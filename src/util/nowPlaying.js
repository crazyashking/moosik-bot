...
module.exports = {
  async nowPlaying(player, client) {
    return embedContent(`[\`Patreon\`](https://patreon.com/uzox)  |  [\`Invite\`](https://discord.com/oauth2/authorize?client_id=${client.user.id}&permissions=8&scope=bot+applications.commands)  |  [\`Vote\`](https://top.gg/bot/${client.user.id})  |  [\`Support Server\`](https://discord.gg/GtNTAr5EWR)`)
